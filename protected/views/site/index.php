...
<section class="home-slider owl-carousel">
    <div class="slider-item" style="background-image: url('<?php echo Yii::app()->request->baseUrl; ?>/img/slider-1.jpg');">
        <div class="container">
    ...
    <div class="slider-item" style="background-image: url('<?php echo Yii::app()->request->baseUrl; ?>/img/slider-2.jpg');">
        <div class="container">
    ...
    <div class="slider-item" style="background-image: url('<?php echo Yii::app()->request->baseUrl; ?>/img/slider-3.jpg');">
        <div class="container">
            <div class="row slider-text align-items-center justify-content-center text-center">
                <div class="col-md-7 col-sm-12 element-animate">
                    <h1>VENTAS POR MAYOR Y MENOR</h1>
    ...
    <div class="slider-item" style="background-image: url('<?php echo Yii::app()->request->baseUrl; ?>/img/slider-4.jpg');">
        <div class="container">
            <div class="row slider-text align-items-center justify-content-center text-center">
                <div class="col-md-7 col-sm-12 element-animate">
                    <h1>VENTAS POR MAYOR Y MENOR</h1>
                ...
                <div>
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            ...
                            <textarea name="message" id="mensaje" class="form-control form-control-lg" cols="30" rows="8" name="mensaje"></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 form-group">
